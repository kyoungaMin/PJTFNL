...
/**
 * GET /api/forecast-weekly/customers?sku=...
 * 해당 SKU를 수주한 고객사 목록 반환 (weekly_customer_summary × customer 조인)
 */
export async function GET(request: Request) {
  ...
  try {
    // Bug3 fix: use customer_name directly from weekly_customer_summary (company_name in customer table is null)
    ...
    console.error('[API] forecast-weekly/customers error:', err)
